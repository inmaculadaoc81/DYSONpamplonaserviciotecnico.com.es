DYCENTER SERVICIO TÉCNICO DYSON EN PAMPLONA
===========================================

Web de una sola página (HTML/CSS/JS estático + función serverless en Vercel)
para DyCenter, servicio técnico y reparación de equipos Dyson con recogida
y entrega en Pamplona y área metropolitana.

Dominio: https://pamplonaserviciotecnico.com.es/
Marca: DyCenter Servicio Técnico Dyson en Pamplona
Ficha de Google: https://maps.app.goo.gl/cpdVf9AUKKMvRAnS9
Mapa: iframe de Google Maps de la ficha de DyCenter, en la sección de contacto (ancho 100% vía CSS).
...
DIRECCIÓN: no se muestra dirección postal. La web indica "Pamplona y área
...
- dycenter.css: identidad visual de la marca. dycenter-header-hero.css: cabecera.
- dycenter.js: menú móvil, formulario y cookies ("dycenter_cookie_preference").
- dycenter-n8n-chat.js / .css: chatbot n8n con el webhook compartido del grupo.
...
PALETA: se mantiene la identidad actual de la marca, color principal #7C5CFC (violeta) con cabecera azul oscuro.
